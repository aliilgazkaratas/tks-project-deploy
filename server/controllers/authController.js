...
export const getMe = async (req, res, next) => {
  try {
    ...
    const user = await User.findById(req.user._id)
      .select('-password')
      .populate('attendedEvents', 'title date location imageUrl');
...
export const logout = async (req, res, next) => {
  try {
    ...
    // This endpoint exists for consistency and potential future features (e.g., token blacklisting)
...
// register: Creates user, generates token, sends welcome email
// login: Verifies credentials, returns token
// getMe: Returns current user data with populated events
// updateProfile: Allows name/email/picture updates
